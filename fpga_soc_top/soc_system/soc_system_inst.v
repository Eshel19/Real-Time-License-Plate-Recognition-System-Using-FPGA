	soc_system u0 (
		...
		.data_from_hps_export                  (<connected-to-data_from_hps_export>),                  //   data_from_hps.export
		.data_from_hps_block_read_export       (<connected-to-data_from_hps_block_read_export>),       //                .block_read_export
		.data_from_hps_data_ready_export       (<connected-to-data_from_hps_data_ready_export>),       //                .data_ready_export
		.data_to_hps_block_read                (<connected-to-data_to_hps_block_read>),                //     data_to_hps.block_read
		.data_to_hps_export                    (<connected-to-data_to_hps_export>),                    //                .export
		.data_to_hps_read_request              (<connected-to-data_to_hps_read_request>),              //                .read_request
		...
		.hps_commade_export                    (<connected-to-hps_commade_export>),                    //     hps_commade.export
